import { serializeClearCookie, serializeCookie } from "../core/cookie";
import type { AdapterResponseInit } from "../core/types";

export function createFetchResponse(init: AdapterResponseInit) {
